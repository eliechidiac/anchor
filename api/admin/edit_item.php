...
if(!$original_name || !$name || !$food_supplier || !$price || !$type){
...
if(!$message){
	...
	$query = '	
	UPDATE foods
	SET name = "' . $_POST['name'] . '", type = "' . $_POST['type'] . '", price = "' . $_POST['price'] . '", description = "' . $_POST['description'] . '"
	WHERE name = "' . ucfirst($_POST['original_name']) . '"';
